...
import ModalDescriaoPartida from '../../components/Modals/DescricaoPartida/modalDescricaoPartidaModal';
...
function CalendarioPage() {
  ...
  return (
    <div className='calendario-container'>
      <h1 className='text-3xl font-bold underline text-center pt-4 text-black'>Calendário do {team.name}</h1>
      <div className="mt-4">
        <FullCalendar
            ...
            eventContent={arg => {
              ...
              return (
                <div style={{ color: "black" }}>
                  <b>{arg.event.title}</b>
                  <div> Começa ás: {horaInicio}</div> 
                  <div style={{ color: "#1321c0ff" }}>
                    <Button 
                      variant="secondary" 
