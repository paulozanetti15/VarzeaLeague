...
export default {
  getTeamFriendlyMatchesHistory,
  getTeamChampionshipMatchesHistory,
  getFriendlyMatchReport,
  createFriendlyMatchReport,
  updateFriendlyMatchReport,
  deleteFriendlyMatchReport,
  getChampionshipMatchReport,
  updateChampionshipMatchReport,
  deleteChampionshipMatchReport
};
